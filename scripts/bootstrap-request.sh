...
copy_workflows() {
  for workflow in bootstrap feature bugfix refactor review security-review improvement-cycle rule-evolution; do
...
- Copied canonical `.agent/` files, roles, prompt fragments, workflows, adapters, and scripts.
